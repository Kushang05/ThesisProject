...
{
    [AllowAnonymous]
    public class RegisterFacutlyModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    await _userManager.AddToRolesAsync(user, new string[] { MyIdentityRoleNames.Mentor.ToString() });
